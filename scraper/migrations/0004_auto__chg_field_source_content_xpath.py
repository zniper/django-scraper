...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source.content_xpath'
        db.alter_column(u'scraper_source', 'content_xpath', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Source.content_xpath'
        db.alter_column(u'scraper_source', 'content_xpath', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
