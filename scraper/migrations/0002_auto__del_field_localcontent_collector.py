...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocalContent.collector'
        db.delete_column(u'scraper_localcontent', 'collector_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LocalContent.collector'
        raise RuntimeError("Cannot reverse this migration. 'LocalContent.collector' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'LocalContent.collector'
        db.add_column(u'scraper_localcontent', 'collector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scraper.Collector']),
                      keep_default=False)
