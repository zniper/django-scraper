# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-06-08 17:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[(b'crawl', 'crawl & scrape data'), (b'extract', 'extract from single page'), (b'read', 'get readable content')], default=b'crawl', max_length=32)),
